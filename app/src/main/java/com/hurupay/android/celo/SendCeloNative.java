...
public class SendCeloNative extends AsyncTask<String, Void, String> {
    ...
    public SendCeloNative(Context context){
        this.context = context;
    }
    public interface Callback {
    }

    public SendCeloNative(Context context, Callback callback) {
        this.context = context;
