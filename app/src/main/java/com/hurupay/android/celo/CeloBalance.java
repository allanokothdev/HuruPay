...
public class CeloBalance extends AsyncTask<String, Void, String> {
    ...
    public CeloBalance(Context context){
        this.context = context;
    }
    public interface Callback {
    }

    public CeloBalance(Context context, Callback callback) {
        this.context = context;
    ...
    protected String doInBackground(String... urls) {
        try {
            ...
            ContractKitOptions config = new ContractKitOptions.Builder().setFeeCurrency(CeloContract.StableToken).setGasPrice(BigInteger.valueOf(21_000)).build();
