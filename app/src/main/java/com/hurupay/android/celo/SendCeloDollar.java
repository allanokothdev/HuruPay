...
public class SendCeloDollar extends AsyncTask<String, Void, String> {
    ...
    public SendCeloDollar(Context context){
        this.context = context;
    }
    public interface Callback {
    }

    public SendCeloDollar(Context context, Callback callback) {
        this.context = context;
